...
Spin HTTP health check API built with [scala-wasm](https://github.com/scala-wasm/scala-wasm).
...
Stable Spin 4.0.0 does not expose the required `--experimental-wasm-feature` flag yet. These features are available [only in canary build](https://github.com/spinframework/spin/pull/3377).
